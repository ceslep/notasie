...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4">
  ...
  <div class="p-5 space-y-3">
    <label class="text-xs font-semibold text-slate-600">Mensaje</label>
    <textarea rows="4" bind:value={mensaje} class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all resize-none"></textarea>
    <div class="space-y-1">
